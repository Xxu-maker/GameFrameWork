...
namespace HybridCLR.Editor
{
    public static class BuildAssetsCommand
    {
        ...
        [MenuItem("HybridCLR/Build/BuildHotDllAndAOTDLLCopyToCode")]
        public static void BuildAndCopyABHotUpdateDlls()
        {
            BuildTarget target = EditorUserBuildSettings.activeBuildTarget;
            CompileDllCommand.CompileDll(target);
            CopyABAOTHotUpdateDlls(target);
        ...
        public static void CopyAOTAssembliesToStreamingAssets()
        {
            ...
            string aotAssembliesDstDir = Application.dataPath+"/AssetPack/Code";
        ...
        public static void CopyHotUpdateAssembliesToStreamingAssets()
        {
            ...
            string hotfixAssembliesDstDir = Application.dataPath + "/AssetPack//Code";
